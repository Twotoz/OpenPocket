...
confirms the exact 1.0 mm eight-layer stack-up and returns an impedance review.

L2 (`GND1`) and L7 (`GND2`) are uninterrupted reference planes and must never
carry signal tracks. Ordinary signals and width-controlled power routes may
use F.Cu, SIG1, SIG2, SIG3, SIG4, and B.Cu subject to the critical-route order
below.
...
| `Ground` | 0.10 mm | 0.50 mm | 0.70 / 0.35 mm | L2/L7 plane fan-out and stitching |
...
3. Route main power and ground fan-out, then verify return paths on L2/L7.
