...
NET_CLASS_MEMBERS = {
    ...
    "HighCurrent": {
        "BAT_CELL_NEG", "BAT_RAW", "PMID", "SYS_ALWAYS", "SYS_SWITCHED",
...
add("U2","1S charger/power path","Texas Instruments","BQ25895RTWR",
    ...
    ("TS","BAT_NTC"),("QON","CHG_QON"),("BAT","BAT_RAW"),
    ("BAT","BAT_RAW"),("SYS","SYS_ALWAYS"),("SYS","SYS_ALWAYS"),
...
add("U4","fuel gauge","Analog Devices","MAX17048G+T10","C2682616",
    ...
    ("VDD","BAT_RAW"),("GND",G),("ALRT","GAUGE_ALERT"),
...
resistors=[
 ...
 ("R55","10","RC0402FR-0710RL","C138066","BAT_RAW","GAUGE_CELL"),
...
caps=[
 ...
 ("C31","10u 25V","CGA0805X7R106K250MT","C6119932","0805","BAT_RAW",G),
